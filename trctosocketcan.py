...
def convert(trc, socketcan):
    for line in trc:
        ...
        socketcan.write(
            "({seconds:020.6f}) can0 {id:08X}#{data}\n".format(
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--trc", type=argparse.FileType("r"), default=None)
    parser.add_argument("-s", "--socketcan", type=argparse.FileType("w"), default=None)
